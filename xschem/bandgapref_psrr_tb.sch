...
C {vsource.sym} -260 -180 0 0 {name=V1 value="dc 1.8 ac 1" savecurrent=true}
...
C {code_shown.sym} 520 -270 0 0 {name=spice only_toplevel=false value="
.temp 25
.option savecurrents
.option klu
.option method=gear
...
wrdata v_out_psrr.txt db(out_0v3)

.endc"}
C {gnd.sym} 0 -60 0 0 {name=l1 lab=GND}
C {bandgapref.sym} 0 -190 0 0 {name=x1}
C {capa.sym} 160 -110 0 0 {name=C2
m=1
value=20p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 160 -60 0 0 {name=l4 lab=GND}
C {lab_pin.sym} 160 -170 2 0 {name=p2 sig_type=std_logic lab=out_1v}
C {capa.sym} 440 -110 0 0 {name=C3
m=1
value=20p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 440 -60 0 0 {name=l5 lab=GND}
C {lab_pin.sym} 440 -170 2 0 {name=p3 sig_type=std_logic lab=out_0v3}
C {capa.sym} 320 -90 0 0 {name=C4
m=1
value=20p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 320 -40 0 0 {name=l6 lab=GND}
C {lab_pin.sym} 320 -150 2 0 {name=p4 sig_type=std_logic lab=out_0v6}
C {vsource.sym} 120 0 0 0 {name=V2 value=0.9 savecurrent=true}
C {gnd.sym} 120 60 0 0 {name=l7 lab=GND}
C {lab_pin.sym} 120 -60 2 1 {name=p5 sig_type=std_logic lab=Iout_10u}
