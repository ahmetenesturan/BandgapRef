...
N 100 -190 320 -190 {lab=out_0v8}
N 320 -150 320 -120 {lab=out_0v8}
N 320 -60 320 -40 {lab=GND}
N 320 -190 320 -150 {lab=out_0v8}
...
C {sky130_fd_pr/corner.sym} -150 240 0 0 {name=CORNER only_toplevel=true corner=tt}
C {devices/launcher.sym} -260 70 0 0 {name=h1
descr="Annotate OP" 
...
C {code_shown.sym} 620 -940 0 0 {name=spice only_toplevel=false value="
.temp 25
.control
option savecurrents
option klu
...
op
write bandgapref_dc_temp_sweep_tb.raw
...
wrdata v_out_dc_temp_sweep.txt out_0v3
wrdata i_out_dc_temp_sweep.txt i(v2)
